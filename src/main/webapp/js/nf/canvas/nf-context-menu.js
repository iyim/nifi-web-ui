...
(function (root, factory) {
    ...
    var menuItems = [
        ...
        {id: 'version-menu-item', groupMenuItem: {clazz: 'fa', text: 'Version'}, menuItems: [
            ...
            {id: 'revert-menu-item', condition: hasLocalChanges, menuItem: {clazz: 'fa fa-undo', text: '还原本地更改', action: 'revertLocalChanges'}},
            {id: 'change-version-menu-item', condition: supportsChangeFlowVersion, menuItem: {clazz: 'fa', text: '改变版本', action: 'changeFlowVersion'}},
            {separator: true},
        ...
        {separator: true},
        {id: 'start-menu-item', condition: isRunnable, menuItem: {clazz: 'fa fa-play', text: '开始运行', action: 'start'}},
        ...
        {id: 'enable-menu-item', condition: canEnable, menuItem: {clazz: 'fa fa-flash', text: '开启', action: 'enable'}},
        {id: 'disable-menu-item', condition: canDisable, menuItem: {clazz: 'icon icon-enable-false', text: '禁用', action: 'disable'}},
        {id: 'enable-transmission-menu-item', condition: canStartTransmission, menuItem: {clazz: 'fa fa-bullseye', text: '开启传输', action: 'enableTransmission'}},
        {id: 'disable-transmission-menu-item', condition: canStopTransmission, menuItem: { clazz: 'icon icon-transmit-false', text: '禁用传输', action: 'disableTransmission'}},
        {separator: true},
        {id: 'data-provenance-menu-item', condition: canAccessProvenance, menuItem: {clazz: 'icon icon-provenance', imgStyle: 'context-menu-provenance', text: '查看数据来源', action: 'openProvenance'}},
        ...
        {id: 'show-usage-menu-item', condition: hasUsage, menuItem: {clazz: 'fa fa-book', text: '查看用法', action: 'showUsage'}},
        {id: 'view-menu-item', groupMenuItem: {clazz: 'icon icon-connect', text: '查看连接'}, menuItems: [
            {id: 'show-upstream-menu-item', condition: hasUpstream, menuItem: {clazz: 'icon', text: '上游', action: 'showUpstream'}},
            {id: 'show-downstream-menu-item', condition: hasDownstream, menuItem: {clazz: 'icon', text: '下游', action: 'showDownstream'}}
        ]},
        {separator: true},
        {id: 'refresh-remote-flow-menu-item', condition: isRemoteProcessGroup, menuItem: {clazz: 'fa fa-refresh', text: '刷新远程流', action: 'refreshRemoteFlow'}},
        {separator: true},
        {id: 'remote-ports-menu-item', condition: isRemoteProcessGroup, menuItem: {clazz: 'fa fa-cloud', text: '远程管理端口', action: 'remotePorts'}},
        {id: 'manage-policies-menu-item', condition: canManagePolicies, menuItem: {clazz: 'fa fa-key', text: '管理访问策略', action: 'managePolicies'}},
        {id: 'change-version-menu-item', condition: canChangeProcessorVersion, menuItem: {clazz: 'fa fa-exchange', text: '改变版本', action: 'changeVersion'}},
        {separator: true},
        {id: 'show-source-menu-item', condition: isConnection, menuItem: {clazz: 'fa fa-long-arrow-left', text: '查看原', action: 'showSource'}},
        {id: 'show-destination-menu-item', condition: isConnection, menuItem: {clazz: 'fa fa-long-arrow-right', text: '查看目标', action: 'showDestination'}},
        {separator: true},
        {id: 'align-menu-item', groupMenuItem: {clazz: 'fa', text: 'Align'}, menuItems: [
            {id: 'align-horizontal-menu-item', condition: canAlign, menuItem: { clazz: 'fa fa-align-center fa-rotate-90', text: '水平', action: 'alignHorizontal'}},
            {id: 'align-vertical-menu-item', condition: canAlign, menuItem: {clazz: 'fa fa-align-center', text: '垂直', action: 'alignVertical'}}
        ]},
        {id: 'to-front-menu-item', condition: canMoveToFront, menuItem: {clazz: 'fa fa-clone', text: '置前', action: 'toFront'}},
        {id: 'center-menu-item', condition: isNotConnection, menuItem: {clazz: 'fa fa-crosshairs', text: '居中', action: 'center'}},
        {id: 'fill-color-menu-item', condition: isColorable, menuItem: {clazz: 'fa fa-paint-brush', text: '改变颜色', action: 'fillColor'}},
        {id: 'open-uri-menu-item', condition: isRemoteProcessGroup, menuItem: {clazz: 'fa fa-external-link', text: '打开链接', action: 'openUri'}},
        {separator: true},
        {id: 'move-into-parent-menu-item', condition: canMoveToParent, menuItem: {clazz: 'fa fa-arrows', text: '转至父组', action: 'moveIntoParent'}},
